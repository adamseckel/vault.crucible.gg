...
export default({className, style, onAuthorize, SignInButton}) => {
  ...
  return <Column css={`composes: ${animations.fadeInSlow}; position: absolute; top: 60px; bottom: 0; left: 0; right: 0;`}>
    ...
    <Text gray size={2} css={`composes: ${animations.fadeInSlow}; animation-delay: 1000ms; opacity: 0; margin-bottom: 20px;`}> Fast, Simple, Gear Management and Loadouts for Destiny 2. </Text>
